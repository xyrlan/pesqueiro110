        ...
        <div className="sm:container px-4 sm:px-6 lg:px-8 py-32">
          ...
          <div className='flex flex-col md:flex-row gap-5 my-5'>
            <div className='md:w-1/2 flex flex-col items-center gap-2'>
              ...
              <p><strong className='text-secondary'>Diária:</strong> R$ 150,00</p>
          ...
          <Button size={'lg'} variant={'primary'} className='md:mt-20 my-10 w-full'><Link href={'https://wa.me/556793140747/?text=Ol%C3%A1%2C%20eu%20gostaria%20de%20agendar%20minha%20pesca'}>Agendar minha pesca</Link></Button>
        </div>
      </section>
    )
  }
