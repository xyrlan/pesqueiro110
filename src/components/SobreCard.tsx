...
const SobreCard = ({ image, text, title, href }: any) => {
  return (
    <Link href="#" className="group relative block h-64 sm:h-80 lg:h-96 w-full text-white">
      ...
      <div
        className="relative flex h-full transform items-end border-2 border-primary bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2"
      >
        ...
        <span className="absolute h-full w-full max-sm:bg-primary max-sm:bg-opacity-30 from-black/40 group-hover:from-70% to-transparent bg-gradient-to-t transition-all duration-300 "></span>
